...
# 2. 加载或预处理数据集
# ======================
from dataset_utils_final import get_or_create_dataset_chunk_dsc_his
...
def main():
    ...
    # Step 1: 获取帧级数据集
    ds = get_or_create_dataset_chunk_dsc_his(DATA_DIR, CACHE_DIR, num_grid_r=NUM_GRID_R, num_grid_c=NUM_GRID_C, num_chunk=NUM_CHUNK)
    vds = get_or_create_dataset_chunk_dsc_his(VAL_DATA_DIR, VAL_CACHE_DIR, num_grid_r=NUM_GRID_R, num_grid_c=NUM_GRID_C, num_chunk=NUM_CHUNK)
    vuds = get_or_create_dataset_chunk_dsc_his(VAL_U_DATA_DIR, VAL_U_CACHE_DIR, num_grid_r=NUM_GRID_R, num_grid_c=NUM_GRID_C, num_chunk=NUM_CHUNK)
