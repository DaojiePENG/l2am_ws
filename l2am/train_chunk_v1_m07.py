...
augment_ratio = 0.7  # 可调整比例

# training configs
OUTPUT_DIR = "outputs/l2a_bigbird_action_classifier_chunk4_v1_6_m07"
NUM_EPOCHS = 30
...
WANDB_RUN_NAME = "bigbird-action-chunk4-pred-depth-sem-v1-6-m07"  # 可选：设置 wandb 实验名称
LOGGING_STEPS = 100
EVAL_STEPS = 500
SAVE_STEPS = 500
