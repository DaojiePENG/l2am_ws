...
augment_ratio = 0.8  # 可调整比例

# training configs
OUTPUT_DIR = "outputs/l2a_bigbird_action_classifier_chunk4_v1_6_m08"
NUM_EPOCHS = 30
...
WANDB_RUN_NAME = "bigbird-action-chunk4-pred-depth-sem-v1-6-m08"  # 可选：设置 wandb 实验名称
LOGGING_STEPS = 100
EVAL_STEPS = 500
SAVE_STEPS = 500
