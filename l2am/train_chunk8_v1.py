...
CACHE_DIR = "data/cache/train_frames_chunk8_v1_6"
VAL_DATA_DIR = "data/l2am_r2r_v3/val_seen/6"
VAL_CACHE_DIR = "data/cache/val_seen_frames_chunk8_v1_6"
NUM_GRID_R = 6
NUM_GRID_C = 6
...
# training configs
OUTPUT_DIR = "outputs/l2a_bigbird_action_classifier_chunk8_v1_6"
NUM_EPOCHS = 30
...
WANDB_RUN_NAME = "bigbird-action-chunk8-pred-depth-sem-v1-6"  # 可选：设置 wandb 实验名称
LOGGING_STEPS = 100
EVAL_STEPS = 500
SAVE_STEPS = 500
