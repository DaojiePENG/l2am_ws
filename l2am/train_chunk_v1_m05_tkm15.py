...
CACHE_DIR = "data/cache/train_frames_chunk4_v1_6_m05_tkm15"
VAL_DATA_DIR = "data/l2am_r2r_v3/val_seen/6"
VAL_CACHE_DIR = "data/cache/val_seen_frames_chunk4_v1_6_m05_tkm15"
VAL_U_DATA_DIR = "data/l2am_r2r_v3/val_unseen/6"
VAL_U_CACHE_DIR = "data/cache/val_unseen_frames_chunk4_v1_6_m05_tkm15"
...
MASK_PROB = 0.15  # Token Masking 概率
...
WANDB_RUN_NAME = "bigbird-action-chunk4-pred-depth-sem-v1-6-m05_tkm15"  # 可选：设置 wandb 实验名称
LOGGING_STEPS = 100
EVAL_STEPS = 500
SAVE_STEPS = 500
...
# 3. Tokenize 函数
# ======================
from dataset_utils import tokenize_function_mask_v1
...
def main():
    ...
    if os.path.exists(os.path.join(OUTPUT_DIR, "tokenized_train")) and os.path.exists(os.path.join(OUTPUT_DIR, "tokenized_eval")):
        ...
        tokenized_train = train_ds.map(
            lambda x: tokenize_function_mask_v1(x, tokenizer, max_length=MAX_LENGTH, mask_prob=MASK_PROB),
            batched=True,
