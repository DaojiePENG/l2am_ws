...
CACHE_DIR = "data/cache/train_frames_chunk4_his4_s_m08"
VAL_DATA_DIR = "data/l2am_r2r_v3/val_seen/6"
VAL_CACHE_DIR = "data/cache/val_seen_frames_chunk4_his4_s_m08"
VAL_U_DATA_DIR = "data/l2am_r2r_v3/val_unseen/6"
VAL_U_CACHE_DIR = "data/cache/val_unseen_frames_chunk4_his4_s_m08"
...
# training configs
OUTPUT_DIR = "outputs/l2a_bigbird_action_classifier_chunk4_his4_s_m08"
NUM_EPOCHS = 30
...
WANDB_RUN_NAME = "bigbird-action_chunk4_his4_s_m08"  # 可选：设置 wandb 实验名称
LOGGING_STEPS = 100
EVAL_STEPS = 1000
SAVE_STEPS = 1000
...
def main():
    ...
    # Step 1: 获取帧级数据集
    ds = get_or_create_dataset_chunk_s_his(DATA_DIR, CACHE_DIR, num_grid_r=NUM_GRID_R, num_grid_c=NUM_GRID_C, num_chunk=NUM_CHUNK)
    vds = get_or_create_dataset_chunk_s_his(VAL_DATA_DIR, VAL_CACHE_DIR, num_grid_r=NUM_GRID_R, num_grid_c=NUM_GRID_C, num_chunk=NUM_CHUNK)
    vuds = get_or_create_dataset_chunk_s_his(VAL_U_DATA_DIR, VAL_U_CACHE_DIR, num_grid_r=NUM_GRID_R, num_grid_c=NUM_GRID_C, num_chunk=NUM_CHUNK)
