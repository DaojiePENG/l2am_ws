...
# 用法: scripts/launch_train_chunk4_his4_dsc_m08_rxr.sh <id> [suffix]
# 例如: scripts/launch_train_chunk4_his4_dsc_m08_rxr.sh 01 chunk4_his4_dsc_m08_rxr
...
nohup bash -c '
    torchrun \
        --nproc_per_node=1 \
        --master_port=29501 \
        l2am/train_chunk4_his4_dsc_m08_rxr.py \
        > "'"$LOG_FILE"'" 2> "'"$ERR_FILE"'"
